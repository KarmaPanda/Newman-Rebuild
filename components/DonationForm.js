    ...
    if (venmo) {
      fetch("/api/checkout", {
        ...
        body: JSON.stringify({
          ...
          email: state.email,
          classYear:
            state.classYear == "Other"
              ? state.classYearOptional
              : state.classYear,
          description: state.description,
          referral:
            state.referral == "Other" ? state.referralOptional : state.referral,
            ...
            <form className="p-5" onSubmit={handleFormSubmit}>
              ...
              <div className="form-group mb-3">
                ...
                <small id="emailHelp" className="form-text text-muted">
                  Your email will be used to confirm your identity. We will not
              ...
              {classYearOptional ? (
                <div className="form-group mb-3">
                  ...
                  <input
                    ...
                    onChange={handleOptionalClassYear}
                    value={state.classYearOptional}
                  />
                </div>
              ) : null}
              ...
              <div className="form-group mb-3">
                <label htmlFor="referralOptional">
                ...
                <>
                  ...
                  {venmo ? (
                    <div className="text-center">
                      <p>
                        You will be redirected to our Venmo page where you can
                        place your donation after clicking the button below.
                      </p>
                    </div>
                  ) : null}
